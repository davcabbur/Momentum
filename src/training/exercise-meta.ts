...
export const EXERCISE_META: Record<string, ExMeta> = {
  ...
  'Pec fly en polea': { region: 'estiramiento', equipment: 'cable', compound: false },
  // Hombro
  ...
  'Extensión tríceps en máquina': { region: 'lateral-media', equipment: 'machine', compound: false },
  // Espalda
  'Jalón al pecho': { region: 'vertical', equipment: 'cable', compound: true },
  'Jalón neutro': { region: 'vertical', equipment: 'cable', compound: true },
  'Jalón cerrado': { region: 'dorsal-bajo', equipment: 'cable', compound: true },
  ...
  'Remo en T': { region: 'horizontal', equipment: 'barbell', compound: true },
  'Remo en polea': { region: 'horizontal', equipment: 'cable', compound: true },
  ...
  'Sentadilla sissy': { region: 'cuadriceps', equipment: 'bodyweight', compound: false },
  ...
  'Rueda abdominal': { region: 'total', equipment: 'bodyweight', compound: false },
  // Antebrazo
  ...
  Flexiones: { region: 'medio', equipment: 'bodyweight', compound: true },
  'Press inclinado en máquina': { region: 'superior', equipment: 'machine', compound: true },
  'Press en Smith': { region: 'medio', equipment: 'machine', compound: true },
  'Press inclinado en Smith': { region: 'superior', equipment: 'machine', compound: true },
  'Press militar en Smith': { region: 'anterior', equipment: 'machine', compound: true },
  'Elevación frontal con mancuerna': { region: 'anterior', equipment: 'dumbbell', compound: false },
  'Extensión tríceps cuerda': { region: 'lateral-media', equipment: 'cable', compound: false },
  'Press francés con mancuerna': { region: 'larga', equipment: 'dumbbell', compound: false },
  'Fondos en máquina': { region: 'lateral-media', equipment: 'machine', compound: true },
  'Fondos en banco': { region: 'lateral-media', equipment: 'bodyweight', compound: false },
  'Remo bajo': { region: 'horizontal', equipment: 'cable', compound: true },
  'Remo bajo agarre supino': { region: 'dorsal-bajo', equipment: 'cable', compound: true },
  ...
  'Curl martillo en polea': { region: 'braquial', equipment: 'cable', compound: false },
  'Prensa horizontal': { region: 'cuadriceps', equipment: 'machine', compound: true },
  'Aductor en máquina': { region: 'aductores', equipment: 'machine', compound: false },
  'Sentadilla goblet': { region: 'cuadriceps', equipment: 'dumbbell', compound: true },
  'Peso muerto sumo': { region: 'isquios', equipment: 'barbell', compound: true },
  'Zancada en Smith': { region: 'accesorio', equipment: 'machine', compound: true },
  'Gemelo en Smith': { region: 'gemelo', equipment: 'machine', compound: false },
  'Patada de glúteo en máquina': { region: 'medio', equipment: 'machine', compound: false },
