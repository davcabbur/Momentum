...
const makeStyles = (c: Theme) =>
  ...
  deloadBox: { backgroundColor: c.warnSurface, borderColor: c.warnBorder, borderWidth: 1, borderRadius: 12, padding: 12, marginTop: 8, gap: 8 },
  deloadTxt: { color: c.warn, fontSize: 12, lineHeight: 18 },
  deloadBtn: { backgroundColor: c.warnBorder, borderRadius: 9, paddingVertical: 8, alignItems: 'center' },
  deloadBtnTxt: { color: c.warn, fontWeight: '800', fontSize: 13 },
